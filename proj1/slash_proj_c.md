# Slash [(Project c)](https://github.com/TommasU/slash)
## Grading Rubric
...
|-----|------|---------|
|Video|2|2 mins video of new functionality, showing a significant delta from prior: Video is more than 2 minutes (5 mins)|
|Workload is spread over the whole team (one team member is often Xtimes more productive than the others but nevertheless, here is a track record that everyone is contributing a lot)|1|[Based on the number of commits](https://github.com/TommasU/slash/graphs/contributors), not everyone contributed significantly |
|Number of commits|3||
|Number of commits: by different people|2|<b>Member 1</b>: 26 commits, 889 additions, 1047 deletions <br /> <b>Member 2:</b> 19 commits, 19143 additions, 1148 deletions<br /> <b>Member 3:</b> 4 commits, 339 additions, 52 deletions <br /> <b>Member 4:</b>8 commits, 480 additions, 355 deletions <br /> <b>Member 5:</b> 2 commits, 66 additions, 21 deletions |
|Issues reports: there are **many**|3|[Issues on GitHub](https://github.com/TommasU/slash/issues?q=is%3Aissue+is%3Aclosed)
|Issues are being closed|3|All are closed|
...
|Docs: short video, animated, hosted on your repo. That convinces people why they want to work on your code.|0|Just the main video, describes the whole project and the updates.
|Use of version control tools|0|
|Use of style checkers |1|Added Python Style Checker, but did not use.|
|Use of code formatters. |0||
|Use of syntax checkers. |1|Added Pylint, but did not use.|
|Use of code coverage |3|Used codecov|
|Other automated analysis tools|1|used additional tools for displaying licence, the number of issues, and pull requests|
|Test cases exist|3|dozens of tests and those test cases are more than 30% of the code base: code coverage is 70% |
|Test cases are routinely executed|0|E.g. travis-com.com or github actions or something|
|The files CONTRIBUTING.md lists coding standards and lots of tips on how to extend the system without screwing things up|2| The file was not updated by the new team working on it.
|Issues are discussed before they are closed|even if you discuss in slack, need a sumamry statement here|2| For some yes, and for some no.
|Chat channel: exists|0|Link or screenshots: Not available|
|Test cases: a large proportion of the issues related to handling failing cases.|1|If a test case fails, open an issue and fix it: Many issues are related to missing features|
|Evidence that the whole team is using the same tools: everyone can get to all tools and files|2|some tools are mentioned [here](https://github.com/TommasU/slash/blob/main/CONTRIBUTING.md)|
|Evidence that the whole team is using the same tools (e.g. config files in the repo, updated by lots of different people)|1| There are no workflow runs under GH actions. Also, commits are mostly done by two members.
...
|Evidence that the members of the team are working across multiple places in the code base|3| Members commit history show they worked on different parts of code.
